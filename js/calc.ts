 ...
 *
 * ### Entry Classification (see CLAUDE.md "Overtime Calculation Guide")
 ...
 * - `CLAUDE.md` - Overtime calculation guide (detailed algorithm walkthrough)
 ...
 *
 * This function implements the **capacity precedence hierarchy** defined in CLAUDE.md.
 ...
 *
 * ## Key Business Logic (see CLAUDE.md for full details)
 *
 ...
 * @see docs/prd.md - Business rules definition
 * @see CLAUDE.md - Detailed overtime calculation guide
 */
export function calculateAnalysis(
    ...
    for (const [userId, userEntries] of entriesByUser) {
        ...
        for (const dateKey of allDates) {
            ...
            // --- CAPACITY ADJUSTMENTS (see CLAUDE.md for rules) ---
            ...
            // 3. Fallback time-off from entries
            ...
            for (const entry of sortedEntries) {
                ...
                // This implements the tail attribution algorithm (see CLAUDE.md)
                ...
                if (overtimeHours > 0 && tier2Multiplier > multiplier) {
                    ...
                    // Case 2: Still below tier2 threshold (all new OT is tier1)
